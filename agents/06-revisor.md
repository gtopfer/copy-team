...
**Antes de revisar, ler `./persona.md` na íntegra** — especialmente a seção "What High Boy Never Does" e os exemplos de calibração. Ter em mente o vocabulário identificado pelo Agente 3 e as restrições de produto do Agente 2.
