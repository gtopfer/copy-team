...
- Para cada **conta própria** listada em `./references.md`, identificar o que já foi publicado para evitar repetição
- Produzir um bloco de **inteligência social** com:
  ...
  - Lacunas identificadas que o projeto ou a marca podem preencher
